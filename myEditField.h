...
const byte FLD_BYTE_MAXVALUE_180 PROGMEM =180;
//const byte FLD_BYTE_MAXVALUE_99 PROGMEM =99;
const byte FLD_BYTE_MAXVALUE_95 PROGMEM =95;
const byte FLD_BYTE_MINVALUE_5 PROGMEM =5;
...
const int FLD_INT_MAXVALUE_1000 PROGMEM =1000;
